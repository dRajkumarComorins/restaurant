...
export class RestaurantControllerBase {
  ...
  @common.Get("/:id/cuisines")
  @ApiNestedQuery(CuisineFindManyArgs)
  async findManyCuisines(
    @common.Req() request: Request,
    @common.Param() params: RestaurantWhereUniqueInput
  ): Promise<Cuisine[]> {
    const query = plainToClass(CuisineFindManyArgs, request.query);
    const results = await this.service.findCuisines(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/cuisines")
  async connectCuisines(
    @common.Param() params: RestaurantWhereUniqueInput,
  ...
  @common.Patch("/:id/cuisines")
  async updateCuisines(
    @common.Param() params: RestaurantWhereUniqueInput,
    @common.Body() body: CuisineWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/cuisines")
  async disconnectCuisines(
    @common.Param() params: RestaurantWhereUniqueInput,
    @common.Body() body: CuisineWhereUniqueInput[]
  ): Promise<void> {
    const data = {
